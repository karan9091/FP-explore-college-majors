...
const unimportantTags = new Set(['VB', 'VBD', 'VBG', 'VBN', 'VBP', 'VBP', 'IN', 'CC', 'CD', 'DT', 'EX', 'LS', 'MD', 'PDT', 'POS', 'PRP', 'PRP$', 'TO', 'WP', 'WP$', 'WRB', 'WDT', 'RP']);
const throwaways = new Set(['then', 'had', 'they', 'didn', 'how', 'couldn','don', 'isn', 'from', 'you', 'just', 'get', 'are', 'will', 'but', 'and', 'all', 'this', 'that', 'what', 'the', 'his', 'her', 'was', 'also', 'there', 'yet', 'not', 'with', 'for', 'its', 'say']);
